...
function App() {
  ...
  //     setIsLoggedIn(true);
  //   }
  // }, []); //without depenencies this will only run once, when the app starts,because the depenedies never changed because we have none.
...
// check the index.js code to see how we wrap the app component with </AuthContext.Provider>
export default App;
